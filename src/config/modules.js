...
export const MODULES = [
  {
    ...
    tabs: [],
    manageActions: [
      { key: 'proyectos.manage', label: 'Crear / editar / eliminar proyectos' },
    ],
  },
  {
    key: 'tickets',
    ...
    tabs: [],
    manageActions: [
      { key: 'tickets.manage', label: 'Crear y gestionar tickets' },
    ],
  },
  {
    key: 'ads',
    ...
    tabs: [],
    manageActions: [
      { key: 'ads.manage', label: 'Crear / editar / eliminar campañas' },
    ],
  },
  {
    key: 'tareas',
  ...
  },
  {
    ...
    manageActions: [
      { key: 'evaluaciones.manage', label: 'Crear / guardar evaluaciones' },
    ],
  },
  {
    key: 'reportes',
