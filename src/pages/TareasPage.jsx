...
const VIEWS = [
  {
    ...
    descAll:
      'Esta sección es la cartelera general de todos los teams. Aquí ves de un vistazo cómo va la agencia esta semana: el porcentaje de cierre de cada team, quién lidera y los números globales. Úsala para detectar rápido dónde hace falta apoyar.',
  },
  {
    key: 'base',
    label: 'Base',
          ...
          {!loading && teams.length === 0 && !canViewAll && (
            <div className="bg-white rounded-xl border border-[#e0ddd4] p-10 text-center mb-4">
              ...
              <p className="text-[15px] text-[#bbb]">
                Crea las líneas desde <strong>Empresa → Líneas</strong> para empezar a gestionar
                tareas
              </p>
            </div>
          )}
