...
const MODULE_ICON = {
  proyectos: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="1" y="1" width="6" height="6" rx="1.5"/><rect x="9" y="1" width="6" height="6" rx="1.5"/><rect x="1" y="9" width="6" height="6" rx="1.5"/><rect x="9" y="9" width="6" height="6" rx="1.5"/></svg>,
  tickets: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="1" y="3" width="14" height="10" rx="1.5"/><path d="M1 6h14" strokeLinecap="round"/></svg>,
  ads: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><path d="M2 11V5l6-3 6 3v6l-6 3-6-3Z" strokeLinejoin="round"/></svg>,
  tareas: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="1.5" y="2" width="13" height="12" rx="1.5"/><path d="M5 6h6M5 9h4" strokeLinecap="round"/></svg>,
  empresa: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><rect x="1" y="4" width="14" height="10" rx="1.5"/><path d="M1 8h14" strokeLinecap="round"/></svg>,
  evaluaciones: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><circle cx="8" cy="5.5" r="2.5"/><path d="M2 14c0-3.3 2.7-6 6-6s6 2.7 6 6" strokeLinecap="round"/></svg>,
  reportes: <svg width="18" height="18" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.6"><polyline points="1 12 5 7 8 10 11 5 15 8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
}

const ICON_ASSIGNED = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="3" y="2" width="10" height="12" rx="1.5"/><path d="M6 1.5h4v1.5H6z"/><path d="M5.5 8.5l1.5 1.5 3-3.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
const ICON_LATE = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><circle cx="8" cy="9" r="5.5"/><path d="M8 6.5V9l2 1.2" strokeLinecap="round" strokeLinejoin="round"/><path d="M5.5 1.5h5M3 3l1-1M13 3l-1-1" strokeLinecap="round"/></svg>
const ICON_SUPPORT = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><path d="M8 1.5s3 1.2 5 .8v4.6c0 3-2.2 5.2-5 6.1-2.8-.9-5-3.1-5-6.1V2.3c2 .4 5-.8 5-.8Z" strokeLinejoin="round"/><path d="M5.7 8l1.6 1.6 3-3.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
const ICON_COMPANY_TASKS = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="1.5" y="2" width="13" height="12" rx="1.5"/><path d="M5 6h6M5 9h4M5 12h2" strokeLinecap="round"/></svg>
const ICON_REPORTS = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><polyline points="1.5 12.5 5.5 7 8.5 10 14.5 3" strokeLinecap="round" strokeLinejoin="round"/><path d="M1.5 14.5h13" strokeLinecap="round"/></svg>
const ICON_CLIENTS = <svg width="16" height="16" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="2" y="6" width="12" height="8" rx="1.5"/><path d="M6 6V4.5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1V6" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 9.5h12" strokeLinecap="round"/></svg>
...
const HEALTH_YEAR = HEALTH_CURRENT_MONTH === 1 ? new Date().getFullYear() - 1 : new Date().getFullYear()
  ...
  return (
    <div className="main-bg min-h-screen">
      <div className="max-w-6xl mx-auto px-5 sm:px-8 py-8 sm:py-10">
        ...
        {/* Panel de bienvenida */}
        <div
          className="rise-in relative overflow-hidden rounded-3xl bg-[#111111] px-6 py-7 sm:px-9 sm:py-9 mb-8"
        >
          <div
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              ...
              {isDirector && (
                <KpiCard
                  ...
                  sub={!loadingTasks && mySupportLateTasks.length > 0 ? `${mySupportLateTasks.length} atrasada(s)` : undefined}
