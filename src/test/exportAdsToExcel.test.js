...
describe('buildAdRows', () => {
  it('mapea las 13 columnas en el orden esperado (sin Responsable)', () => {
    ...
    expect(row).toEqual([
      ...
      80,
      'En Curso',
      '', '', '', '', // resultados vacíos: no está Finalizado
    ])
  })
  ...
  it('rellena las columnas de resultado cuando el ad está Finalizado', () => {
    const finalizado = {
      ...BASE_AD,
      status: 'Finalizado',
      reach: 1000,
    ...
    expect(row.slice(9)).toEqual([1000, 200, 30, 5000])
  })
