...
function DropItem({ label, active, dot, onClick }) {
  return (
    <button
      onClick={onClick}
      className="w-full text-left px-3.5 py-2 text-[14px] font-medium flex items-center gap-2.5 hover:bg-[#f5f3eb] transition-colors"
    >
  ...
  return (
    <div>
      <button
        ...
        className="text-[13px] font-semibold px-2.5 py-0.5 rounded-full whitespace-nowrap hover:opacity-70 transition-opacity"
      >
        {c.label}
      </button>
  ...
  return (
    <div>
      <button
        ...
        onClick={toggle}
        style={{ color: c.text, background: c.bg, border: `1px solid ${c.border}` }}
        className="text-[13px] font-semibold px-2.5 py-1 rounded-full whitespace-nowrap hover:opacity-70 transition-opacity"
      >
        {c.label}
      </button>
      <DropMenu open={open} pos={pos} menuRef={menuRef}>
    ...
    >
      ...
      <div className="px-5 pt-5 pb-4">
        ...
        <div className="flex items-start gap-3 mb-3">
          <h3 className="flex-1 text-[16px] font-semibold text-[#111] leading-snug tracking-[-0.01em]">
            {project.name}
          </h3>
      ...
      <div className="px-5 py-3 border-t border-[#f0ede3] flex items-center justify-between">
        ...
        <div className="flex items-center gap-1">
          <button
            onClick={onEdit}
            className="text-[14px] font-semibold text-[#777] hover:text-[#111] transition-colors px-2.5 py-1 rounded-lg hover:bg-[#f5f3eb]"
          >
            Editar
          </button>
          <button
