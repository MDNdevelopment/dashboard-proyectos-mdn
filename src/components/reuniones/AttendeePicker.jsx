...
export default function AttendeePicker({
  ...
  return (
    <div>
      ...
      {hideQuickGroups && selected.length > 0 && (
        <div className="flex justify-end mb-2">
          <button
            type="button"
            onClick={clearAll}
            title="Quita a todos los participantes agregados"
            className="text-[12px] font-semibold px-2 py-1 rounded-lg text-[#b91c1c] hover:bg-red-50 transition-colors"
          >
            Quitar a todos
          </button>
        </div>
