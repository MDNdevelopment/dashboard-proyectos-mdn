      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col">
        ...
        <div className="px-6 pt-6 pb-4 border-b border-[#ece9df] flex items-start justify-between gap-4">
          <div className="flex-1">
            <h2 className="text-[17px] font-bold text-[#111] leading-snug mb-2">
              {campaign.name}
            </h2>
            <div className="flex items-center gap-2 flex-wrap">
              <span
                className={`text-[11px] font-mono font-bold px-2.5 py-1 rounded-lg ${status?.bg} ${status?.text}`}
              >
        ...
        <div className="px-6 py-5 overflow-y-auto flex-1">
          <div className="grid grid-cols-2 gap-3 mb-4 text-[12px]">
            <div>
              <p className="font-mono font-bold uppercase tracking-widest text-[#888] text-[10px] mb-0.5">
                Cliente
              </p>
          ...
          {campaign.notes && (
            <div className="mb-4">
              <p className="font-mono font-bold uppercase tracking-widest text-[#888] text-[10px] mb-1.5">
                Notas
              </p>
              <p className="text-[13px] text-[#444] whitespace-pre-wrap leading-relaxed bg-[#f5f3eb] rounded-xl p-3">
                {campaign.notes}
              </p>
            </div>
          )}
          ...
          {canManage && (
            <div className="flex gap-2 mt-2">
              <button
                onClick={onEdit}
                className="flex-1 py-2.5 rounded-xl bg-[#FFB800] text-[#111] text-[13px] font-bold hover:bg-[#e6a600] transition-colors"
              >
                Editar
              </button>
              <button
                ...
                disabled={deleting}
                className={`flex-1 py-2.5 rounded-xl text-[13px] font-bold transition-colors disabled:opacity-50 ${
                  confirming
              ...
              {confirming && (
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl border border-[#e0ddd4] text-[13px] font-semibold text-[#555] hover:bg-[#f5f3eb] transition-colors"
                >
                  No
                </button>
              )}
