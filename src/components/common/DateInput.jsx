...
import {
  ...
  addDays, addMonths, subMonths, isSameDay, isSameMonth, format, parseISO,
} from 'date-fns'
      ...
      {open && createPortal(
        ...
        >
          <div className="flex items-center justify-between mb-2">
            ...
            <p className="text-[13px] font-semibold text-[#111] capitalize">
          ...
          <div className="grid grid-cols-7 gap-0.5 mb-1">
            {WEEKDAY_LABELS.map(w => (
              <span key={w} className="text-[10.5px] font-mono text-[#aaa] text-center uppercase">{w}</span>
            ))}
          </div>
              ...
              return (
                <button
                  ...
                  className={[
                    ...
                    disabledDay ? 'text-[#ddd] cursor-not-allowed' :
                      outOfMonth ? 'text-[#ccc] hover:bg-[#f5f3eb]' : 'text-[#333] hover:bg-[#f5f3eb]',
