...
import EmployeeFichaContent from "./EmployeeFichaContent";

/**
 * Modal de solo lectura con la información básica de un empleado (users).
 * Wrapper fino: overlay + botón X + Escape; el cuerpo vive en EmployeeFichaContent
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/25 backdrop-blur-[3px]">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto relative">
        ...
        <EmployeeFichaContent employee={employee} line={line} onClose={onClose} />
      </div>
    </div>
  );
}
